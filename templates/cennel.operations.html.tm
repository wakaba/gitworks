    ...
    <t:for as=$op x=$operations>
      <tr>
        ...
        <td>
          ...
          <p><a pl:href="'/repos/commits?repository_url=' . (percent_encode_c $op->{repository}->{url}) . '&sha=' . percent_encode_c $op->{repository}->{sha}"><t:text value="substr 0, 10, $op->{repository}->{sha}"></a>
